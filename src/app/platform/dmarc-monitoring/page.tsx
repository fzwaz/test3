...
import FreeCheck from "@/features/platform/components/dmarc/FreeCheck";
import PaidTier from "@/features/platform/components/dmarc/PaidTier";
...
export const metadata = {
  title: "DMARC Monitoring — Stop Attackers from Spoofing Your Domain | Risknox",
  description:
    "Continuous SPF, DKIM and DMARC monitoring with real-time alerts when your email authentication breaks — plus a free instant check to see where you stand today.",
};
