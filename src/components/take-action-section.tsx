...
export default function TakeActionSection() {
  return (
    <section className="w-full py-20 md:py-28 bg-black relative border-t border-white/[0.06] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="group relative rounded-2xl bg-[#151718] border border-white/[0.08] hover:border-[#f36734]/40 p-7 sm:p-9 flex flex-col justify-between transition-all duration-300 shadow-[0_15px_40px_rgba(0,0,0,0.85)] overflow-hidden">
            ...
            <div className="mt-8 pt-6 border-t border-white/[0.08] flex items-center justify-between gap-4">
              ...
              <Link
                href="#risk-bite"
                className="group/btn inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-white/15 hover:border-[#f36734] bg-white/[0.02] hover:bg-[#f36734]/10 text-white font-medium text-xs sm:text-sm transition-all duration-200"
              >
