...
const BEFORE = {
  ...
  points: [
    { title: "Data flow confusion", description: "Teams struggle to explain what personal data is collected, where it lives, and who processes it." },
    { title: "Consent record gaps", description: "Consent notices, withdrawal records, and processing purposes stay spread across tools and teams." },
    { title: "Breach response delay", description: "Security, legal, compliance, and business teams lose time deciding what happened and who must be informed." },
    { title: "Vendor blind spots", description: "Processor records, contracts, data sharing, and vendor controls are reviewed too late or too rarely." },
  ],
...
const AFTER = {
  ...
  points: [
    ...
    { title: "Consent organised", description: "Notices, consent records, withdrawal workflows, and owner tasks stay easier to manage." },
    { title: "Breach readiness clear", description: "Incident steps, evidence, escalation paths, owners, and response records stay visible before pressure arrives." },
    { title: "Leadership dashboard", description: "Management sees privacy gaps, overdue tasks, vendor status, risk exposure, and readiness progress in one view." },
  ],
  footer: "DPDPA readiness becomes visible.",
};
        ...
        <Reveal>
          <div className="mb-10 md:mb-12 max-w-2xl">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight leading-[1.12]">
              DPDPA, from scattered proof <span className="text-[#ff7d1c]">to clear control.</span>
            </h2>
