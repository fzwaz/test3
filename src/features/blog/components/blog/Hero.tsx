...
export const Hero: React.FC<HeroProps> = ({ searchQuery, onSearchChange }) => {
  ...
  return (
    <section className="relative min-h-[75vh] md:min-h-[82vh] flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 pt-32 pb-16 overflow-hidden bg-[#000000]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center">
        {/* Resources Badge: 6-dot matrix icon + RESOURCES text */}
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[76px] font-bold text-white tracking-tight leading-[1.08] select-none">
          <span className="block">Insights that help you</span>
          <span className="block mt-1">
            quantify and reduce <span className="text-[#f97316]">risk.</span>
          </span>
        </h1>

        {/* Subtitle description */}
        <p className="mt-7 max-w-2xl text-base sm:text-lg md:text-[19px] text-slate-300 font-normal leading-relaxed">
          Research, guides, and expert perspectives on cybersecurity, risk quantification,
          and securing what matters most to your business.
        </p>

        {/* Search Bar Container */}
        <div className="mt-10 w-full max-w-xl flex justify-center">
