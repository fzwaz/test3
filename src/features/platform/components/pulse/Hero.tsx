...
const SLIDES = [
  ...
  {
    name: "AI-Driven Detection",
    oneLiner:
      "Identify behavioural anomalies, credential exposures, and emerging threats before exploitation.",
  },
  {
    name: "Signal Prioritisation",
    oneLiner:
      "Reduce alert fatigue by filtering noise and highlighting risks that need immediate attention.",
  },
  {
    name: "Real-Time Alerting",
    oneLiner:
      "High-risk signals surfaced with context, the moment suspicious activity is detected.",
  },
];
          ...
          <div className="lg:w-[58%] flex flex-col justify-center items-start">
            ...
            <div style={textStyle(700)} className="mb-7">
              <div className="inline-flex items-center gap-2.5 px-4 py-[7px] rounded-full bg-black/60 border border-orange-500/25 text-orange-400 text-xs font-semibold tracking-[0.22em] uppercase shadow-[0_0_24px_rgba(249,115,22,0.25)] backdrop-blur-md">
                ...
                <span>Risknox Platform · Pulse</span>
              </div>
            </div>
            ...
            <h1 className="text-[38px] sm:text-[50px] lg:text-[60px] font-bold text-[#f4f1ed] tracking-[-0.02em] leading-[1.08] select-none">
              <span className="block overflow-hidden pb-1">
                <span className="block" style={textStyle(900)}>See threats before they</span>
              </span>
              <span className="block overflow-hidden pb-2">
                <span className="block" style={textStyle(1050)}>
                  become <span className="text-[#ff7d1c]">incidents.</span>
                </span>
              </span>
            </h1>
            ...
            <p className="mt-6 max-w-[560px] text-[15px] lg:text-base text-[#cfc9c2] font-normal leading-[1.65]" style={textStyle(1300)}>
              Pulse continuously monitors your infrastructure, detects anomalies
              and emerging threats, and helps your team focus on the signals
