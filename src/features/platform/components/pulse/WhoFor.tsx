...
const ROLES = [
  {
    ...
    description: "Continuously monitor infrastructure and investigate prioritised security signals.",
  },
  {
    title: "Security Leaders",
    description: "Maintain a clearer view of emerging threats and overall security activity.",
  },
  {
    title: "Cloud & Infrastructure Teams",
    description: "Identify changes, exposures, and anomalies across connected environments.",
  },
];
        ...
        <Reveal>
          <div className="mb-10 md:mb-12 max-w-2xl">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight leading-[1.12]">
              Less noise. <span className="text-[#ff7d1c]">More signal.</span>
            </h2>
          </div>
        </Reveal>
