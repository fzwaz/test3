...
import { ArrowRight, CheckCircle2, ClipboardCheck, Radar, FileSearch, Activity, PhoneCall } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto space-y-16 w-full relative z-10">
        ...
        {/* MAIN SECTION GRID (Left Copy vs Right Underwriting Mockup) */}
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-6">
            <Reveal className="space-y-8">
              ...
              <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
                ...
                <span className="text-[#FF6B35] text-xs font-mono font-bold tracking-wider uppercase">Better underwriting starts here</span>
              </div>

              {/* Headline */}
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white tracking-tight leading-[1.2]">
                See the risk behind <br className="hidden md:block" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B35] to-[#FF8C61]">every submission.</span>
              </h2>

              {/* Subtitle Paragraph */}
              <p className="text-white/70 text-base max-w-lg leading-relaxed">
                Compass gives underwriting teams clearer intelligence to assess cyber risk, understand exposure, and make more informed insurance decisions.
              </p>
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                ...
                >
                  ...
                  <span className="relative z-10 text-[#080808]">Explore Compass</span>
                  <ArrowRight className="relative z-10 ml-2 w-5 h-5 text-[#080808] group-hover:translate-x-1 transition-transform" />
                </a>

                <Link
                  href="/contact?role=underwriting-specialist"
                  className="group inline-flex items-center justify-center gap-2 w-full sm:w-auto min-h-[52px] px-8 py-3.5 rounded-[16px] border border-white/15 hover:border-orange-400 text-slate-200 hover:text-white font-semibold text-[16px] transition-all active:scale-[0.98]"
                >
                  <PhoneCall className="w-4 h-4 text-orange-400" />
                  <span>Talk to an underwriting specialist</span>
                </Link>
              </div>
          ...
          {/* Right Column: Risk Profile Mockup */}
            ...
            <Reveal className="w-full flex items-center justify-center" delay={0.15}>
              ...
              <div className="w-full max-w-lg bg-[#1A1A1A] rounded-2xl border border-[#2A2A2A] overflow-hidden flex flex-col shadow-2xl">
                ...
                <div className="flex items-center justify-between px-5 py-4 border-b border-[#2A2A2A]">
                  <div className="text-white/80 font-medium text-sm">Compass — Applicant Risk Profile</div>
                ...
                <div className="p-6 flex flex-col gap-4">
                  {[
                    { Icon: ClipboardCheck, label: "Risk Assessment", value: "Moderate", hot: true },
                    { Icon: Radar, label: "Exposure Signals", value: "12 flagged", hot: false },
                    { Icon: FileSearch, label: "Decision Context", value: "Ready", hot: false },
                    { Icon: Activity, label: "Post-Bind Monitoring", value: "Active", hot: false },
                  ].map((s) => (
                ...
                <div className="px-5 py-4 border-t border-[#2A2A2A] bg-[#161616]">
                  <div className="flex flex-wrap gap-2">
                    {['Coverage', 'Limits', 'Pricing', 'Deductibles'].map((t, i) => (
