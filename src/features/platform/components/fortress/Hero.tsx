...
const SLIDES = [
  {
    name: "Quantify Risk",
    oneLiner:
      "Translate technical cyber exposure into measurable financial impact leadership can act on.",
  },
  {
    name: "Prioritise Exposure",
    oneLiner:
      "Focus on the vulnerabilities and attack paths with the greatest potential business impact.",
  },
  {
    name: "Communicate Clearly",
    oneLiner:
      "Turn complex cybersecurity signals into clear, executive-ready insights and decisions.",
  },
  {
    name: "Live Intelligence",
    oneLiner:
      "Continuous risk visibility — watch exposure move as your environment changes.",
  },
];
          ...
          <div className="lg:w-[58%] flex flex-col justify-center items-start">
            ...
            <div style={textStyle(700)} className="mb-7">
              <div className="inline-flex items-center gap-2.5 px-4 py-[7px] rounded-full bg-black/60 border border-orange-500/25 text-orange-400 text-xs font-semibold tracking-[0.22em] uppercase shadow-[0_0_24px_rgba(249,115,22,0.25)] backdrop-blur-md">
                ...
                <span>Risknox Platform · Fortress</span>
              </div>
            </div>
            ...
            <h1 className="text-[38px] sm:text-[50px] lg:text-[60px] font-bold text-[#f4f1ed] tracking-[-0.02em] leading-[1.08] select-none">
              <span className="block overflow-hidden pb-1">
                <span className="block" style={textStyle(900)}>Know what your cyber</span>
              </span>
              <span className="block overflow-hidden pb-2">
                <span className="block" style={textStyle(1050)}>
                  risk is <span className="text-[#ff7d1c]">actually worth.</span>
                </span>
              </span>
            </h1>
            ...
            <p className="mt-6 max-w-[560px] text-[15px] lg:text-base text-[#cfc9c2] font-normal leading-[1.65]" style={textStyle(1300)}>
              Fortress transforms technical cyber exposure into measurable
              business risk — helping security teams prioritise what matters
              and giving leadership numbers they can act on.
            </p>
