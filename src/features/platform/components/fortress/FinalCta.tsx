...
import { ArrowRight, CheckCircle2, TrendingUp, IndianRupee, ShieldAlert, ExternalLink } from "lucide-react";
          ...
          <div className="lg:col-span-6">
            <Reveal className="space-y-8">
              ...
              <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
                ...
                <span className="text-[#FF6B35] text-xs font-mono font-bold tracking-wider uppercase">Ready to understand your risk?</span>
              </div>

              {/* Headline */}
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white tracking-tight leading-[1.2]">
                Your cyber risk has a business impact. <br className="hidden md:block" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B35] to-[#FF8C61]">Do you know what it is?</span>
              </h2>

              {/* Subtitle Paragraph */}
              <p className="text-white/70 text-base max-w-lg leading-relaxed">
                Fortress helps you move beyond technical scores and understand the risks that matter most to your organisation.
              </p>
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                ...
                >
                  <span className="font-mono tracking-tight">fortress.risknox.ai</span>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="h-16 w-full relative bg-[#222222] rounded-lg border border-[#2A2A2A] overflow-hidden">
                      <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none" viewBox="0 0 100 40">
                        <defs>
                          <linearGradient id="fortress-cta-trend" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="0%" stopColor="#FF6B35" stopOpacity="0.2" />
                            <stop offset="100%" stopColor="#FF6B35" stopOpacity="0" />
                          </linearGradient>
                        </defs>
                        <path d="M0,30 L10,25 L20,28 L30,20 L40,22 L50,15 L60,18 L70,10 L80,12 L90,5 L100,8 L100,40 L0,40 Z" fill="url(#fortress-cta-trend)" className="opacity-50" />
