...
const ROLES = [
  {
    ...
    description: "Prioritise cybersecurity investments based on business impact.",
  },
  {
    title: "Risk Teams",
    description: "Understand and communicate enterprise cyber exposure more clearly.",
  },
  {
    title: "Executives & Boards",
    description: "See cyber risk in business terms — not just technical jargon.",
  },
  {
    title: "Insurance & Risk Professionals",
    description: "Use stronger intelligence to support cyber risk and insurance decisions.",
  },
];
        ...
        <Reveal>
          <div className="mb-10 md:mb-12 max-w-2xl">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight leading-[1.12]">
              Different roles. <span className="text-[#ff7d1c]">One view of risk.</span>
            </h2>
          </div>
        </Reveal>
