...
import { ArrowRight, CheckCircle2, ScanEye, Gauge, FileCheck2, UserCheck } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto space-y-16 w-full relative z-10">
        ...
        {/* MAIN SECTION GRID (Left Copy vs Right Governance Mockup) */}
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-6">
            <Reveal className="space-y-8">
              ...
              <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
                ...
                <span className="text-[#FF6B35] text-xs font-mono font-bold tracking-wider uppercase">Govern AI with confidence</span>
              </div>

              {/* Headline */}
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white tracking-tight leading-[1.2]">
                AI adoption needs more than innovation. <br className="hidden md:block" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B35] to-[#FF8C61]">It needs accountability.</span>
              </h2>

              {/* Subtitle Paragraph */}
              <p className="text-white/70 text-base max-w-lg leading-relaxed">
                Accord helps organisations build visibility, manage AI risk, and establish the governance needed for responsible AI.
              </p>
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                ...
                >
                  ...
                  <span className="relative z-10 text-[#080808]">Explore Accord</span>
                ...
                <div className="flex -space-x-3 items-center justify-center pt-2 sm:pt-0">
                  <div className="w-10 h-10 rounded-full border-2 border-[#080808] bg-[#FF6B35]/10 overflow-hidden flex items-center justify-center">
                    <ScanEye className="w-4 h-4 text-[#FF6B35]" />
                  </div>
                  <div className="w-10 h-10 rounded-full border-2 border-[#080808] bg-[#FF6B35]/10 overflow-hidden flex items-center justify-center">
                    <Gauge className="w-4 h-4 text-[#FF6B35]" />
                  </div>
                  <div className="w-10 h-10 rounded-full border-2 border-[#080808] bg-[#FF6B35]/10 overflow-hidden flex items-center justify-center">
                    <FileCheck2 className="w-4 h-4 text-[#FF6B35]" />
                  </div>
                  <div className="pl-6 text-xs font-semibold text-white/50">
                    Structured <br /> AI governance
                  </div>
                </div>
              </div>
          ...
          {/* Right Column: Governance Snapshot Mockup */}
            ...
            <Reveal className="w-full flex items-center justify-center" delay={0.15}>
              ...
              <div className="w-full max-w-lg bg-[#1A1A1A] rounded-2xl border border-[#2A2A2A] overflow-hidden flex flex-col shadow-2xl">
                ...
                <div className="flex items-center justify-between px-5 py-4 border-b border-[#2A2A2A]">
                  <div className="text-white/80 font-medium text-sm">Accord — AI Governance</div>
                ...
                <div className="p-6 flex flex-col gap-4">
                  {[
                    { Icon: ScanEye, label: "AI Systems Mapped", value: "64", hot: true },
                    { Icon: Gauge, label: "High-Risk Uses", value: "09", hot: false },
                    { Icon: UserCheck, label: "Owners Assigned", value: "58", hot: false },
                    { Icon: FileCheck2, label: "Evidence Records", value: "312", hot: false },
                  ].map((s) => (
                ...
                <div className="px-5 py-4 border-t border-[#2A2A2A] bg-[#161616]">
                  <div className="flex flex-wrap gap-2">
                    {['EU AI Act', 'NIST AI RMF', 'ISO 42001'].map((fw, i) => (
