...
const SLIDES = [
  {
    name: "Map AI Systems",
    oneLiner:
      "Maintain visibility into AI systems, models, vendor services, and AI-powered workflows.",
  },
  {
    name: "Assess AI Risk",
    oneLiner:
      "Identify and evaluate risks across privacy, security, fairness, safety, and robustness.",
  },
  {
    name: "Govern with Confidence",
    oneLiner:
      "Bring policies, responsibilities, controls, and governance activities into one structure.",
  },
  {
    name: "Demonstrate Readiness",
    oneLiner:
      "Maintain the documentation and evidence needed to prove responsible AI governance.",
  },
];
          ...
          <div className="lg:w-[58%] flex flex-col justify-center items-start">
            ...
            <div style={textStyle(700)} className="mb-7">
              <div className="inline-flex items-center gap-2.5 px-4 py-[7px] rounded-full bg-black/60 border border-orange-500/25 text-orange-400 text-xs font-semibold tracking-[0.22em] uppercase shadow-[0_0_24px_rgba(249,115,22,0.25)] backdrop-blur-md">
                ...
                <span>Risknox Platform · Accord</span>
              </div>
            </div>
            ...
            <h1 className="text-[38px] sm:text-[50px] lg:text-[60px] font-bold text-[#f4f1ed] tracking-[-0.02em] leading-[1.08] select-none">
              <span className="block overflow-hidden pb-1">
                <span className="block" style={textStyle(900)}>AI is moving fast.</span>
              </span>
              <span className="block overflow-hidden pb-2">
                <span className="block" style={textStyle(1050)}>
                  Governance should <span className="text-[#ff7d1c]">keep up.</span>
                </span>
              </span>
            </h1>
            ...
            <p className="mt-6 max-w-[560px] text-[15px] lg:text-base text-[#cfc9c2] font-normal leading-[1.65]" style={textStyle(1300)}>
              Accord helps organisations understand their AI landscape, manage
              AI risk, and build the governance needed for responsible and
